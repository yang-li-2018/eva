...
from eva.utils.functional import lazy
...
class Trans(object):
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from eva.utils.translation import trans_real as trans
        else:
            from eva.utils.translation import trans_null as trans
...
def get_language_info(lang_code):
    from eva.conf.locale import LANG_INFO
    try:
